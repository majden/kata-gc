...
public class DepositTest {
	...
	@Test
	public void depositOperationTestOk() {
		Compte cpte = saveService.save(client.getId(), new BigDecimal(50));
		assertTrue(cpte.getSolde().compareTo(new BigDecimal("150.10"))==0);
	}
